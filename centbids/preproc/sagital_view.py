...
1. cd to function
>> cd ~/disks/meso_H/projects/CENTBIDS/analysis_code/preproc/anatomical/
2. run python command
python sagital_view.py [main directory] [project name] [subject num] [video name]
-----------------------------------------------------------------------------------------
Exemple:
python sagital_view.py ~/disks/meso_S/jstellmann/data/ CENTBIDS sub-2100247523 after_edit
-----------------------------------------------------------------------------------------
...
# define directory
fs_dir = "{}/{}/derivatives/freesurfer/{}".format(main_dir, project_dir, subject)
print(fs_dir)
