...
- [x] Merge all figures [merge_fig_prf.py](../analysis_code/postproc/prf/postfit/merge_fig_prf.py) or [merge_fig_prf.sh](../analysis_code/postproc/prf/postfit/merge_fig_prf.sh)
