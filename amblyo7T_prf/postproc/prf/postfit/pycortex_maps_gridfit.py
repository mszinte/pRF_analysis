...
for format_ in formats:
    ...
    if format_ == 'fsnative':
        ...
        deriv_avg_fn_R = '{}/{}_task-{}_hemi-R_dct_concat_prf-deriv_gauss_gridfit.func.gii'.format(
            prf_deriv_dir, subject, output_folder)
        ...
        deriv_avg_fn = '{}/{}_task-{}_dct_concat_prf-deriv_gauss_gridfit.dtseries.nii'.format(
            prf_deriv_dir, subject, output_folder)
