...
-----------------------------------------------------------------------------------------
Goal of the script:
Copy individual subject figures (correlation, active vertices, ecc-size-pcm, ecc-comp)
to group folders, organizing them by figure type and task in subdirectories.
...
- Copies ecc-comp figures to group-patient/fsnative/prf/figures-ecc-comp/task-name/
