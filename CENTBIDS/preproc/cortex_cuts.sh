...
# -----------------------------------------------------------------------------------------
# Exemple:
# sh cortex_cuts.sh /scratch/jstellmann/data CENTBIDS sub-2100247523 skling lh
# sh cortex_cuts.sh /scratch/jstellmann/data CENTBIDS sub-2100247523 skling rh
# -----------------------------------------------------------------------------------------
...
while true; do
    ...
    case $yn in
        [Yy]* ) echo "\n>> Uploading the $3 patch to mesocentre";\
                rsync -avuz --rsh='ssh -p 8822' ~/temp_data/$3/surf/$5.full.patch.3d $4@login.mesocentre.univ-amu.fr:$1/$2/derivatives/freesurfer/$3/surf/
        break;;
