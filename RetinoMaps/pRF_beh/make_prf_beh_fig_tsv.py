...
if 'group' not in subject:
    ...
    # Concat DF
    median_df = pd.concat([median_df, prf_beh_trials_df_group_excluded], ignore_index=True)
    ...
    median_df.to_csv(prf_beh_trials_group_median_tsv_fn, sep="\t", na_rep='NaN', index=False)
