...
Exemple:
cd ~/projects/pRF_analysis/RetinoMaps/glm/postfit/dev
python glm_single_stats_sbatch.py /scratch/mszinte/data RetinoMaps sub-01 327 b327
-----------------------------------------------------------------------------------------
...
compute_stats_cmd = "python compute_glmsingle_stats.py {} {} {} {}".format(
