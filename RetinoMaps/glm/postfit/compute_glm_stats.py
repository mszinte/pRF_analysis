...
python compute_glm_stats.py /scratch/mszinte/data RetinoMaps sub-170k 327
-----------------------------------------------------------------------------------------
...
# Sub-170k median
    ...
    for task in tasks:
        ...
        for subject in subjects:
            subjects_stats_task += ["{}/{}/derivatives/pp_data/{}/170k/glm/glm_derivatives/{}_task-{}_fmriprep_dct_avg_glm-stats_loo-median.dtseries.nii".format(
