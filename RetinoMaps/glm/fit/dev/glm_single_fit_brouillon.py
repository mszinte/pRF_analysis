...
for task in tasks:
    ...
    for preproc_files in preproc_files_list:
        ...
        for preproc_fn in preproc_files :            
            ...
            print('data brain shape is {}'.format(preproc_data_brain.shape))
            print('data roi is {}'.format(preproc_data_rois.shape))
