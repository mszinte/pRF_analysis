    ...
    for format_, extension in zip(formats, extensions):
        ...
        if 'group' not in subject:
            ...
            for categorie_to_plot in categories_to_plot : 
                ...
                # # ROI surface areas 
                # # -----------------
                # data_raw['vert_area'] = data_raw_categorie['vert_area'] / 100 # in cm2
                ...
                # df_roi_area['vert_area_corr_pvalue_5pt'] = np.array(data_raw_categorie[data_raw_categorie['corr_pvalue_5pt'] < 0.05].groupby(
                ...
                # df_roi_area['vert_area_corr_pvalue_1pt'] = np.array(data_raw_categorie[data_raw_categorie['corr_pvalue_1pt'] < 0.01].groupby(
                #     ['roi'], sort=False)['vert_area'].sum())
