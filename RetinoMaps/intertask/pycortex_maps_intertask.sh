...
# Exemple:
# cd ~/disks/meso_H/projects/pRF_analysis/RetinoMaps/intertask
# sh pycortex_maps_intertask.sh ~/disks/meso_H/projects RetinoMaps ~/disks/meso_S/data n 
# -----------------------------------------------------------------------------------------
...
do
    ...
    python pycortex_maps_intertask.py "$data_path" "$project_name" "$subject" "$save_in_overlay"
done