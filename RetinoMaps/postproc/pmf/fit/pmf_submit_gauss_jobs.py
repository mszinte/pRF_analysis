...
for fit_num, pp_fn in enumerate(pp_fns):
    ...
    if pp_fn.endswith('.nii'):
        prf_dir = "{}/{}/170k/pmf".format(pp_dir, subject)
        os.makedirs(prf_dir, exist_ok=True)
        prf_jobs_dir = "{}/{}/170k/pmf/jobs".format(pp_dir, subject)
        ...
        prf_dir = "{}/{}/fsnative/pmf".format(pp_dir, subject)
        os.makedirs(prf_dir, exist_ok=True)
        prf_jobs_dir = "{}/{}/fsnative/pmf/jobs".format(pp_dir, subject)
        os.makedirs(prf_jobs_dir, exist_ok=True)
        prf_logs_dir = "{}/{}/fsnative/pmf/log_outputs".format(pp_dir, subject)
        os.makedirs(prf_logs_dir, exist_ok=True)
