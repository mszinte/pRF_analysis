...
-----------------------------------------------------------------------------------------
Output(s):
Per run:      {subject}_run-0X_task-SacLoc_odm.mp4
Concatenated: {subject}_task-SacLoc_odm.npy
-----------------------------------------------------------------------------------------
To run:
cd ~/projects/pRF_analysis/RetinoMaps/postproc/pmf/fit
python odm_builder_sacloc.py /scratch/mszinte/data RetinoMaps sub-02 327
-----------------------------------------------------------------------------------------
...
for run_idx in range(n_runs):
    ...
    # Save per-run video
    video_fn = f"{save_fn}/{subject}_run-{run_num:02d}_task-SacLoc_odm.mp4"
