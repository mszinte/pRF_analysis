...
for task in tasks :
    ...
    num_seq = task_settings['num_seq']
    seq_trs = task_settings['seq_trs']
    eye_mov_seq = task_settings['eye_mov_seq']
    ...
    seq_9_stop_pattern = task_settings.get("last_trial_pattern")
    seq_1_start_pattern = task_settings.get("first_trial_pattern")
