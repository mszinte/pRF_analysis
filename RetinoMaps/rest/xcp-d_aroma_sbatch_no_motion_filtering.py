...
Here we removed framewise displacement filtering
Which may have weird interactions with AROMA denoising depending on when and how this confound is removed
See this note:
Starting in version 0.4.0, if users request motion parameter filtering, 
filtered motion parameters (including FD, and any squared or derivative regressors) will be used 
for both outlier detection and confound regression.
------------------------------------------------------------------------------------------------------------
Input(s):
