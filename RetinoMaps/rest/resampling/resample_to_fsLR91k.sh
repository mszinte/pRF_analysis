...
ATLAS="~/disks/meso_H/projects/pRF_analysis/RetinoMaps/rest/mmp1_clusters"
...
# TEMPLATE="/projects/pRF_analysis/RetinoMaps/?/fsLR"
	...
	OUT_DIR2="/scratch/mszinte/data/RetinoMaps/derivatives/pp_data/sub-"$i"/91k/rest/seed/target_91k"
		...
		wb_command -cifti-separate "$TASK_RESULTS/sub-"$i"/170k/intertask/sub-"$i"_intertask_Sac_Pur.dtseries.nii" COLUMN -metric CORTEX_LEFT "$OUT_DIR1/sub-"$i"_intertask_Sac_Pur.dtseries.left_hemi.shape.gii";

		wb_command -cifti-separate "$TASK_RESULTS/sub-"$i"/170k/intertask/sub-"$i"_intertask_Sac_Pur.dtseries.nii" COLUMN -metric CORTEX_RIGHT "$OUT_DIR1/sub-"$i"_intertask_Sac_Pur.dtseries.right_hemi.shape.gii";
		...
		wb_command -metric-label-import "$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur.dtseries.left_hemi.bary_largest.shape.gii" intertask_label_list.txt \
		"$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_lh_renamed_cmap.label.gii" && \
		wb_command -metric-label-import "$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur.dtseries.right_hemi.bary_largest.shape.gii" intertask_label_list.txt \
		...
		wb_command -label-mask "$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_lh_renamed_cmap.label.gii" "$ATLAS/atlas-Glasser_space-fsLR_den-32k_filtered_ROIs_left_hemi.shape.gii" \
		"$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_lh_renamed_masked_cmap.label.gii";

		wb_command -label-mask "$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_lh_renamed_cmap.label.gii" "$ATLAS/atlas-Glasser_space-fsLR_den-32k_filtered_ROIs_left_hemi.shape.gii" \
		"$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_lh_renamed_masked_cmap.label.gii";

		wb_command -label-mask "$OUT_DIR2/sub-"$i"_91k_intertask_Sac_Pur_rh_renamed_cmap.label.gii" "$ATLAS/atlas-Glasser_space-fsLR_den-32k_filtered_ROIs_right_hemi.shape.gii" \
