...
ATLAS="/scratch/mszinte/data/RetinoMaps/derivatives/pp_data/atlas"
	...
	OUT_DIR2="$TASK_RESULTS/sub-${i}/91k/rest/seed/target_91k"
		...
		wb_command -metric-resample \
			...
			BARYCENTRIC $LARGEST_FLAG \
			"$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_left_hemi_bary${LARGEST_SUFFIX}.shape.gii" \
		...
		wb_command -metric-resample \
			...
			BARYCENTRIC $LARGEST_FLAG \
			"$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_right_hemi_bary${LARGEST_SUFFIX}.shape.gii" \
		...
		wb_command -metric-label-import "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_left_hemi_bary${LARGEST_SUFFIX}.shape.gii" \
			"$ATLAS/intertask_label_list.txt" \
			"$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_lh_renamed_cmap${LARGEST_SUFFIX}.label.gii" && \
		
		wb_command -metric-label-import "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_right_hemi_bary${LARGEST_SUFFIX}.shape.gii" \
			"$ATLAS/intertask_label_list.txt" \
		...
		wb_command -metric-label-import "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_lh${LARGEST_SUFFIX}.shape.gii" \
			"$ATLAS/7_vision-pursuit-saccade.txt" "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_lh${LARGEST_SUFFIX}.label.gii";
		wb_command -metric-label-import "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_rh${LARGEST_SUFFIX}.shape.gii" \
			"$ATLAS/7_vision-pursuit-saccade.txt" "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_rh${LARGEST_SUFFIX}.label.gii";
