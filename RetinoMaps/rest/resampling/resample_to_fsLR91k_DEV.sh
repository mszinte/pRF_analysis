...
ATLAS="/scratch/mszinte/data/RetinoMaps/derivatives/pp_data/atlas"
	...
	OUT_DIR2="$TASK_RESULTS/sub-${i}/91k/rest/seed/target_91k"
		...
		wb_command -label-mask "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_lh_renamed_cmap.label.gii" \
			"$ATLAS/atlas-Glasser_space-fsLR_den-32k_filtered_ROIs_left_hemi.shape.gii" \
			"$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_lh_renamed_masked_cmap.label.gii";

		wb_command -label-mask "$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_rh_renamed_cmap.label.gii" \
			"$ATLAS/atlas-Glasser_space-fsLR_den-32k_filtered_ROIs_right_hemi.shape.gii" \
			"$OUT_DIR2/sub-${i}_91k_intertask_Sac-Pur-pRF_rh_renamed_masked_cmap.label.gii";
