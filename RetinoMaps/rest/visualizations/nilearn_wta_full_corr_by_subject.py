...
Compute winner take all on parcellated full correlation results
From Nilearn (useful just as a sanity check)
...
output_folder = "/scratch/mszinte/data/RetinoMaps/derivatives/pp_data/group/91k/rest/wta/nilearn"
...
## Compute on which input, full or partial corr results?
# if 
...
for subject in subjects:
    ...
    subj_dir = main_data / Path(subject) / "91k/rest/corr/full_corr/nilearn_full_corr"
    subj_dir.mkdir(parents=True, exist_ok=True)

    csv_file = subj_dir / "cluster_by_mmp-parcel_full.csv"
...
group_result_path = "/scratch/mszinte/data/RetinoMaps/derivatives/pp_data/group/91k/rest/full_corr/nilearn_full_corr"
group_csv = os.path.join(group_result_path, "group_median_cluster_by_mmp-parcel_full.csv")
...
out_csv = Path(output_folder) / "winning_seeds_by_subject_full_corr.csv"
...
consistency_file = Path(output_folder) / "winner_consistency_by_parcel_full_corr.csv"
