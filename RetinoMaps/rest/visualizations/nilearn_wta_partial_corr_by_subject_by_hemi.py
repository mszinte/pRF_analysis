...
for hemi in hemispheres:
    ...
    out_csv = output_folder / f"winning_seeds_by_subject_partial_corr_{hemi}.csv"
    ...
    consistency_file = output_folder / f"winner_consistency_by_parcel_partial_corr_{hemi}.csv"
...
print("="*80)
print(f"\nOutput files:")
print(f"  LH winners: {output_folder}/winning_seeds_by_subject_partial_corr_lh.csv")
print(f"  RH winners: {output_folder}/winning_seeds_by_subject_partial_corr_rh.csv")
print(f"  LH consistency: {output_folder}/winner_consistency_by_parcel_partial_corr_lh.csv")
print(f"  RH consistency: {output_folder}/winner_consistency_by_parcel_partial_corr_rh.csv")
print("\nDone.")