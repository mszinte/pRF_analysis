...
-----------------------------------------------------------------------------------------
Goal of the script:
Submit the nilearn full correlation script to SLURM queue
-----------------------------------------------------------------------------------------
Input(s):
...
python submit_nilearn_compute_full_corr_job.py /scratch/mszinte/data RetinoMaps 327 b327 1:00:00
-----------------------------------------------------------------------------------------
...
script_name = 'nilearn_full_corr_cluster-task_by_mmp-parcel.py'
...
# Create job script
sh_fn = f"{job_dir}/all_nilearn_full_corr.sh"
