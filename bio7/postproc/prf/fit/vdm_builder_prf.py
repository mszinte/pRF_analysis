...
To run:
1. cd to function
>> cd ~/projects/pRF_analysis/[project name]/postproc/prf/fit
2. run python command
>> python vdm_builder_prf.py [main directory] [project name] [group] 
-----------------------------------------------------------------------------------------
Exemple:
cd ~/projects/pRF_analysis/bio7/postproc/prf/fit
python vdm_builder_prf.py /scratch/mszinte/data bio7 327
-----------------------------------------------------------------------------------------
